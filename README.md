...
```html
<link rel="stylesheet" href="bundle/modern-table.min.css">
<script src="bundle/modern-table.min.js"></script>
```
...
| `sortable` | Boolean | Set to `false` to disable sorting for this column. | `true` |
| `searchable` | Boolean | Set to `false` to exclude this column from global search. | `true` |
...
![Modern Table Preview](assets/filtering.png)
